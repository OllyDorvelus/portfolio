...
export const experience: ExperienceEntry[] = [
  {
    ...
    bullets: [
      "Migrated 600M+ records from legacy tables with zero downtime to support a new folder system allowing students to organize diverse study materials, including sets, documents, and media, together for the first time. Redesigned the ORM to handle both integer and string-based IDs and wrote batch migration scripts that were later adopted by the Teacher-Led Study team.",
      "Decoupled core search from a legacy monolith into a Go microservice, unlocking independent feature development for the Search and Discovery team and enabling faster iteration on search performance without being blocked by monolith release cycles.",
      "Owned course content recommendations in a FastAPI microservice end-to-end, including Spanner table design, multi-platform API endpoints, and Datadog monitoring. Powered recommendations across folder pages and new school course pages.",
  ...
  },
  {
    ...
    location: "New York, NY",
    bullets: [
      "Built a REST API layer on top of the Django monolith to decouple backend services and support the textbook and Q&A product, delivering step-by-step solutions for user-generated questions and textbook content to millions of students.",
      "Authored the RFC and implemented a Python FastAPI misspelling microservice, reducing the zero search results rate by returning relevant results for misspelled queries. Expanded search coverage by indexing video transcripts and titles into Elasticsearch and integrating video content into blended search results.",
      "Migrated Search Pages to a new rendering architecture using TypeScript, Next.js, and React, enabling server-side rendering and decoupling frontend delivery from monolith-served web pages.",
  ...
  },
  {
    ...
    location: "New York, NY",
    bullets: [
      "Refactored outdated partner adapters across Go server-to-server and JavaScript client codebases to fix broken integrations, increasing overall ad revenue by 15%.",
      "Built an automated reporting pipeline on the Django admin server to eliminate manual data entry for the AdOps team, reducing manual data entry by 70%.",
